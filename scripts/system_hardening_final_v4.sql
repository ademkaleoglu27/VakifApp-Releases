-- =====================================================
-- SYSTEM HARDENING FINAL V4 (Production Ready)
-- =====================================================
-- What changed (V4):
-- 1. Added DB-level UNIQUE INDEX on vakiflar.code (A request) to prevent race conditions.
--    This complements the RPC check with a hard DB constraint.

-- 0. DB-LEVEL UNIQUENESS (Vakiflar)
