...
import { PrayerTimesScreen, QiblaCompassScreen, PrayerSettingsScreen } from '@/features/prayer';
import { ZikirmatikScreen } from '@/features/zikir';
                ...
                <View style={drawerStyles.cardContent}>
                    ...
                    >
                        ...
                        <View style={drawerStyles.itemsContainer}>
                            ...
                            {/* Kur'an-ı Kerim (Hat & Meal) */}
                            <DrawerItem
                                label="Kur'an-ı Kerim"
                                icon="book-outline"
                                onPress={() => navigate('QuranTextMenuScreen')}
                                color="#047857"
                            />

                            {/* Namaz Vakitleri & Kıble */}
                            <DrawerItem
                                label="Namaz Vakitleri & Kıble"
                                icon="time-outline"
                                onPress={() => navigate('PrayerTimesScreen')}
                                color="#064E3B"
                            />

                            {/* Akıllı Zikirmatik */}
                            <DrawerItem
                                label="Akıllı Zikirmatik"
                                icon="radio-button-on-outline"
                                onPress={() => navigate('ZikirmatikScreen')}
                                color="#B45309"
                            />

                            {/* Cevşen-i Kebir */}
                            <DrawerItem
                                label="Cevşen-i Kebir"
                                icon="shield-checkmark-outline"
                                onPress={() => navigate('CevsenScreen')}
                                color="#1E40AF"
                            />
                            ...
                            <DrawerItem
                                ...
                                onPress={() => navigate('TesbihatScreen')}
                                color="#854D0E"
                            />
                ...
                >
                    <View style={{ flex: 1 }}>
                        <Stack.Navigator screenOptions={{ headerShown: false }}>
                            ...
                            <Stack.Screen name="PrayerTimesScreen" component={PrayerTimesScreen} options={{ headerShown: false }} />
                            <Stack.Screen name="QiblaCompassScreen" component={QiblaCompassScreen} options={{ headerShown: false }} />
                            <Stack.Screen name="PrayerSettingsScreen" component={PrayerSettingsScreen} options={{ headerShown: false }} />
                            <Stack.Screen name="ZikirmatikScreen" component={ZikirmatikScreen} options={{ headerShown: false }} />
                        </Stack.Navigator>
                        <MiniPlayer />
                    </View>
                </NavigationContainer>
