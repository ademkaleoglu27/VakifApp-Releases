...
export type ContentPackStore = UseBoundStore<StoreApi<ContentPackState>>;

export const createContentPackStore = (storageKey: string, defaultTotalPages: number = 0) => {
    return create<ContentPackState>()(
        persist(
            (set) => ({
