...
// --- ⚙️ CONFIGURATION ---
const WORK_SLUG = 'isaratul_icaz';          // work_id
const WORK_TITLE = 'İşârâtü\'l-İ\'câz';
const BOOK_ID = 'risale.isaratul_icaz@diyanet.tr';
const VERSION = 'v1';
const ORDER_INDEX = 6;                      // After Asâ-yı Musa
const JSON_FILENAME = 'isaratul-icaz.json'; // Source file
// ------------------------
...
function ingestBook() {
    ...
    const regressionCheck = db.prepare(`
        ...
        FROM sections 
        WHERE work_id IN ('sozler','mektubat','lemalar','sualar','asayi_musa') 
        GROUP BY work_id
    `).all();
