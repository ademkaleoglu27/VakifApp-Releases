...
// --- ⚙️ CONFIGURATION ---
const WORK_SLUG = 'kastamonu_lahikasi';         // work_id
const WORK_TITLE = 'Kastamonu Lâhikası';
const BOOK_ID = 'risale.kastamonu_lahikasi@diyanet.tr';
const VERSION = 'v1';
const ORDER_INDEX = 10;                     // After Barla Lâhikası
const JSON_FILENAME = 'kastamonu-lahikasi.json'; // Verified filename
// ------------------------
...
function ingestBook() {
    ...
    const regressionCheck = db.prepare(`
        ...
        FROM sections 
        WHERE work_id IN ('sozler','mektubat','lemalar','sualar','asayi_musa','isaratul_icaz','mesnevi_nuriye','sikke_i_tasdik_i_gaybi','barla_lahikasi') 
        GROUP BY work_id
    `).all();
