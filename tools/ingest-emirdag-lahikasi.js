...
// --- ⚙️ CONFIGURATION ---
const WORK_SLUG = 'emirdag_lahikasi';       // work_id
const WORK_TITLE = 'Emirdağ Lâhikası';
const BOOK_ID = 'risale.emirdag_lahikasi@diyanet.tr';
const VERSION = 'v1';
const ORDER_INDEX = 11;                     // After Kastamonu Lâhikası
const JSON_FILENAME = 'emirdag-lahikasi.json'; // Verified filename
// ------------------------
...
function ingestBook() {
    ...
    const regressionCheck = db.prepare(`
        ...
        FROM sections 
        WHERE work_id IN ('sozler','mektubat','lemalar','sualar','asayi_musa','isaratul_icaz','mesnevi_nuriye','sikke_i_tasdik_i_gaybi','barla_lahikasi','kastamonu_lahikasi') 
        GROUP BY work_id
    `).all();
