...
// --- ⚙️ CONFIGURATION ---
const WORK_SLUG = 'asayi_musa';             // work_id
const WORK_TITLE = 'Asâ-yı Musa';
const BOOK_ID = 'risale.asayi_musa@diyanet.tr';
const VERSION = 'v1';
const ORDER_INDEX = 5;
const JSON_FILENAME = 'asayi-musa.json';    // Verified filename from assets
// ------------------------
...
function ingestBook() {
    ...
    const regressionCheck = db.prepare("SELECT work_id, COUNT(*) as c FROM sections WHERE work_id IN ('sozler','mektubat','lemalar','sualar') GROUP BY work_id").all();
