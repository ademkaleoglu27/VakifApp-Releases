...
// --- ⚙️ CONFIGURATION ---
const WORK_SLUG = 'tarihce_i_hayat';        // work_id
const WORK_TITLE = 'Tarihçe-i Hayat';
const BOOK_ID = 'risale.tarihce_i_hayat@diyanet.tr';
const VERSION = 'v1';
const ORDER_INDEX = 12;                     // After Emirdağ Lâhikası
const JSON_FILENAME = 'tarihce-i-hayat.json'; // Verified filename
// ------------------------
...
function ingestBook() {
    ...
    const regressionCheck = db.prepare(`
        ...
        FROM sections 
        WHERE work_id IN ('sozler','mektubat','lemalar','sualar','asayi_musa','isaratul_icaz','mesnevi_nuriye','sikke_i_tasdik_i_gaybi','barla_lahikasi','kastamonu_lahikasi','emirdag_lahikasi') 
        GROUP BY work_id
    `).all();
