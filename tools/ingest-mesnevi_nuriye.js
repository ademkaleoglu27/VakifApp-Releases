...
// --- ⚙️ CONFIGURATION ---
const WORK_SLUG = 'mesnevi_nuriye';         // work_id
const WORK_TITLE = 'Mesnevî-i Nuriye';
const BOOK_ID = 'risale.mesnevi_nuriye@diyanet.tr';
const VERSION = 'v1';
const ORDER_INDEX = 7;                      // After İşârâtü'l-İ'câz
const JSON_FILENAME = 'mesnevi-nuriye.json'; // Source file (verified name)
// ------------------------
...
function ingestBook() {
    ...
    const regressionCheck = db.prepare(`
        ...
        FROM sections 
        WHERE work_id IN ('sozler','mektubat','lemalar','sualar','asayi_musa','isaratul_icaz') 
        GROUP BY work_id
    `).all();
